...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        public async Task<Category> GetCategoryByUnleashProductGuidAsync(string guid)
        {
            var query = _categoryRepository.Table;
            var isExist = await query.Where(x => x.UnleashProductGroupGuId == guid).FirstOrDefaultAsync();
            return isExist;
        }
